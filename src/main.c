...
int main(void)
{
  ...
  // test_apply_effect(kb, EFFECT_BREATHING, TARG_KEYS, 800, (keyboard_color_t) { 0xFF, 0x00, 0x00 });
  // test_apply_effect(kb, EFFECT_CYCLE, TARG_KEYS, 800, (keyboard_color_t) { 0x00, 0x00, 0x00 });
  // test_apply_effect(kb, EFFECT_BREATHING, TARG_KEYS, 800, (keyboard_color_t) { 0x00, 0x00, 0xFF });
  // test_apply_effect(kb, EFFECT_BREATHING, TARG_LOGO, 800, (keyboard_color_t) { 0xFF, 0x00, 0xFF });
  // test_apply_status_color(kb, (keyboard_color_t) { 0xFF, 0x00, 0xFF });
  // test_boot_mode(kb, BOOT_FACTORY);
  // test_loop_keys(kb, (keyboard_color_t) { 0xFF, 0x00, 0x00 });
